    ...
    <section className="py-24 px-4 bg-gray-50">
      <div className="container mx-auto" dir="rtl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {reviews.map((review) => (
            <div key={review.id} className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              {/* Customer Name */}
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold font-arabic mb-3" style={{ color: '#FF8500' }}>
                  {review.name}
                </h3>
              ...
              <div className="text-center">
                <p className="text-gray-700 font-arabic text-base leading-relaxed">
                  {review.text}
                </p>
              </div>
            </div>
